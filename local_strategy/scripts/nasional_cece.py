...
class Pose():
	Initial 		= [2750, -6250, 0]      # [3750, -6250, 0]
	DropBall 		= [0, -5750, 0]         # [2000, -1250, 0]
	KickOffHome 	= [0, -5750, 0]         # [750, -750, -1045]
	KickOffAway 	= [0, -5750, 0]         # [500, -2250, 1000]
	GoalKickHome 	= [0, -6000, 0]         # [2000, -4500, 0]
	GoalKickAway 	= [0, -5750, 0]         # [2000, -750, 0]
	FreeKickHome	= [0, -5750, 0]         # [2000, -1000, 0]
	FreeKickAway	= [0, -5750, 0]         # [2000, -3250, 0]
	CornerHome 		= [0, -5750, 0]			# [3500, 6250, 1135]
	CornerAway 		= [0, -5750, 0]			# [3500, -2750, -180]
	PenaltyHome 	= [0, -5750, 0]			# [0, -1000, 0]
	PenaltyAway 	= [0, -4450, 0]			# [3000, -3750, 0]
	Defense			= [0, -5750, 0]			# [1000, -3750, 0]
...
def Play():
	...
	while enable == Enable.OnPlay:
		GotoBall()
		if ball_lost:
			# SetAbsPose([500, -5750, 1000], ball_found_monitor=True)
			# SetAbsPose([-500, -5750, 1000], ball_found_monitor=True)
			SetAbsPose([0, -5750, 1000], ball_found_monitor=True)
			pass
		else:
			pass
