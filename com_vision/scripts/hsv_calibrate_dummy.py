...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
	...
	while not rospy.is_shutdown():
		...
		mask = cv2.inRange(hsv, (hue_min_black, sat_min_black, val_min_black), (hue_max_black, sat_max_black, val_max_black))
		...
		sat_min_output = int(max(sat - 127, 0))
		sat_max_output = int(min(sat + 127, 255))
		val_min_output = int(max(val - 30, 0))
		val_max_output = int(min(val + 30, 255))
